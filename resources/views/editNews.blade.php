                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form method="POST" action="{{ route('editedNews', $news->id) }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="title">Judul</label>
                                        <input type="text" class="form-control" id="title" placeholder="Masukan nama"
                                        ...
                                        <ul>
                                            <li>
                                                <img src="{{ asset('images/' . $news->image) }}"
                                                    alt="Image of {{ $news->name }}" width="90">
                                            </li>
                                        </ul>
                                    </div>
